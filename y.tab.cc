...
void expandWildcards(std::string* arg_s) {
  ...
  char* regex = new char[2 * strlen(arg_c) + 10];
  *regex = '^';
  regex++;
  while (*arg_c) {
    if (*arg_c == '*') {
...
{
       0,   111,   111,   115,   120,   124,   124,   134,   135,   139,
     151,   162,   179,   190,   206,   220,   221,   225,   228,   232,
     236,   239,   245,   246
};
#endif
